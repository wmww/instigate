from instigate import task, RunCtx, Result, SuccessResult
from .subprocess import execute_run, scout_run

from typing import Optional, Dict
import logging

def current_options(ctx: RunCtx) -> Dict[str, str]:
...
def git_config(options: Disct[str, str]) -> None:
